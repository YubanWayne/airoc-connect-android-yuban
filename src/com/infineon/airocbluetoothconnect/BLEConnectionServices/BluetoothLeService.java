...
package com.infineon.airocbluetoothconnect.BLEConnectionServices;
...
import com.infineon.airocbluetoothconnect.BLEProfileDataParserClasses.BloodPressureParser;
import com.infineon.airocbluetoothconnect.BLEProfileDataParserClasses.CSCParser;
import com.infineon.airocbluetoothconnect.BLEProfileDataParserClasses.CapSenseParser;
...
import com.infineon.airocbluetoothconnect.BLEProfileDataParserClasses.HRMParser;
import com.infineon.airocbluetoothconnect.BLEProfileDataParserClasses.HTMParser;
import com.infineon.airocbluetoothconnect.BLEProfileDataParserClasses.RGBParser;
import com.infineon.airocbluetoothconnect.BLEProfileDataParserClasses.RSCParser;
import com.infineon.airocbluetoothconnect.BLEProfileDataParserClasses.SensorHubParser;
...
public class BluetoothLeService extends Service {
    ...
    public final static String ACTION_OTA_DATA_AVAILABLE =
            "com.airocbluetoothconnect.bluetooth.le.ACTION_OTA_DATA_AVAILABLE";
    public final static String ACTION_OTA_DATA_AVAILABLE_V1 =
            "com.airocbluetoothconnect.bluetooth.le.ACTION_OTA_DATA_AVAILABLE_V1";
        ...
        public void onConnectionStateChange(BluetoothGatt gatt, int status, int newState) {
            ...
            // GATT Server disconnected
                ...
                mHandler.post(new Runnable() {
                    @Override
                    public void run() {
                        // The connection might drop due to the kit being manually reset
...
//                    pairDevice(); // TODO: Android automatically pairs in this case
        ...
        public void onCharacteristicWrite(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic, int status) {
            ...
            Logger.d(mContext.getResources().getString(R.string.app_name_ascii), dataLog);
