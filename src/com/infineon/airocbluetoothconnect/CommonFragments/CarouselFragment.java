...
public class CarouselFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //0000054a-0000-1000-8000-00805f9b34fb  DB設定
        //0000054a-0000-1000-8000-00805f9b34fb11 實際讀到(後面多出流水號)
        ...
        mCarouselButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mUuid.equals("0000054a-0000-1000-8000-00805f9b34fb113"))
                {
                    if(false)
                    {
                        mService = mBleHashMap.get("0000180f-0000-1000-8000-00805f9b34fb97");
                    ...
                    mCurrentUUID = mService.getUuid();
                    CO2InformationService batteryInfoFragment = CO2InformationService.create(mService);
                    displayView(batteryInfoFragment, getResources().getString(R.string.co2_info_fragment));
                }else {
